...
void update_GameObject(SMapData &g_mapData, SGameChar &g_sChar, enemyStruct _enemy[], Portal &_portal, EGAMESTATES &g_eGameState, short &totalNumObject);				//GameObject Indivisual function call
...
void updateLR_EBall(string &ID, COORD &xy, int &speed, bool &reverse, SMapData &g_mapData, SGameChar &g_sChar, enemyStruct _enemy[], Portal &_portal, EGAMESTATES &g_eGameState);						//Right Left Crushing Block
